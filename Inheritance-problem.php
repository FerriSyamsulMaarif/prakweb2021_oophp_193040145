...
class Produk {
    ...
    public function __construct($judul = "judul", $penulis = "penulis", $penerbit = 
        "penerbit", $harga = 0, $jmlHalaman = 0, $waktuMain = 0, $tipe = 0 ) {
        $this->judul = $judul;
...
$produk1 = new Produk("Naruto", "Masashi Kishimoto", "Shoenen Jump", 30000, 100, 0, "Komik");
...
// Komik : Naruto | Mashashi Kisimoto, Shonen Jump (Rp. 30000) - 100 Halaman.
// Game : Uncharted | Neil Druckmann, Sony Komputer (Rp. 250000) - 50 Jam.  
